...
const PaymentForm = () => {
  return (
    <>
      ...
      <div className=" min-w-screen min-h-screen  flex items-center justify-center px-5 pb-10 ">
        <div className="w-full mx-auto rounded-lg bg-white  p-5 text-gray-700" style={{ maxWidth: "800px" }}>
      ...
      <div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
        <div>
          <a title="Buy me a beer" href="https://baya.vn/" target="_blank" className="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img className="object-cover object-center w-full h-full rounded-full" src="https://tse3.mm.bing.net/th?id=OIP.UQ2lPp8vQ6ZvAWurJJPz_wHaHa&pid=Api&P=0&h=220" />
          </a>
        </div>
      </div>
    </>
